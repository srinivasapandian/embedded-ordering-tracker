...
const rawPriorities: RawPriority[] = [
  ...
  ['krishna-vilas-cumming.brisqueemb.com', 0, 'Production cutover rehearsal', 'medium', 'tm06', 2, 'review'],
  ...
  ['rotate-social-tx.brisqueemb.com', 0, 'Soft-launch ordering QA', 'high', 'tm10', 2, 'in-progress'],
  ['brisqueemb.com', 0, 'Marketing site migration sprint', 'medium', 'tm07', 5, 'in-progress'],
  // Next week
